...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'vamsinandan40@gmail.com' ")
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="#3ece48",bg="#262523" ,width=55 ,height=1,font=('times', 19, ' bold '))
...
head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="blue",bg="#3ece48" ,font=('times', 17, ' bold ') )
...
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages  ,fg="blue"  ,bg="yellow"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
trackImg.place(x=30,y=50)
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy  ,fg="blue"  ,bg="red"  ,width=35 ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
